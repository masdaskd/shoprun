!function (e) {
    ...
    var t = {
        initialised: !1, mobile: !1, init: function () {
            this.initialised || (this.initialised = !0, this.checkMobile(), this.stickyHeader(), this.mMenuIcons(), this.mMenuToggle(), this.mobileMenu(), this.scrollToTop(), this.quantityInputs(), this.countTo(), this.tooltip(), this.popover(), this.changePassToggle(), this.changeBillToggle(), this.ajaxLoadProduct(), this.toggleFilter(), this.toggleSidebar(), this.productTabSroll(), this.scrollToElement(), this.loginPopup(), this.modalView(), this.productManage(), this.ratingTooltip(), this.windowClick(), e.fn.superfish && this.menuInit(), e.fn.owlCarousel && this.owlCarousels(), "object" == typeof noUiSlider && this.filterSlider(), e.fn.themeSticky && this.stickySidebar(), e.fn.magnificPopup && this.lightBox())
            ...
            i.owlCarousel(e.extend(!0, {}, t, {
                ...
                autoplay: !1,
                animateOut: "fadeOut"
            })), jQuery(".home-slider ul.scene").parallax(), i.on("loaded.owl.lazy", function (t) {
                e(t.element).closest(".home-slide").addClass("loaded")
            }), e(".home-slider-thumbs").find("a").on("click", function (t) {
                var o = e(this);
                if (!o.hasClass("active")) {
                    var n = o.index();
                    i.trigger("to.owl.carousel", [n]), o.addClass("active").siblings().removeClass("active")
                }
                t.preventDefault()
                ...
                margin: 20,
                autoplay: !1,
                responsive: {0: {items: 2}, 480: {items: 2}, 768: {items: 3}, 992: {items: 5}, 1200: {items: 6}}
            })), e(".widget-featured-products").owlCarousel(e.extend(!0, {}, t, {
                lazyLoad: !0,
                nav: !0,
                dots: !1,
                autoHeight: !0
            })), e(".product-section-slider").owlCarousel(e.extend(!0, {}, t, {
                lazyLoad: !0,
                autoplay: !1,
                animateOut: "fadeOut"
            })), e(".product-section-slider").on("loaded.owl.lazy", function (t) {
                e(t.element).closest(".product-section-slide").addClass("loaded")
