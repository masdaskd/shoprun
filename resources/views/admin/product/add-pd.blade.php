                                    ...
                                    <div class="arrtb-vl card-body">
                                        ...
                                        @foreach($color as $value)
                                            <label class="custom-control custom-checkbox custom-control-inline colorPd" style="display:none;">
                                                <input type="checkbox" value="{{$value->id}}" name="arrtibute_value_id[]"  class="custom-control-input"><span class="custom-control-label"><i class="fas fa-square-full" style="color:{{$value->name_arrtb_value}} "></i></span>
                                            </label>
                                        @endforeach
                                    </div>
