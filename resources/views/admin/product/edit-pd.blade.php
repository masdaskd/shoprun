                                            ...
                                            <div class="col-md-12" style="padding-left: 0px;padding-right: 0px;">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input id="inputUserName" type="text" value="{{$pro->ma_sp}}" name="ma_sp" data-parsley-trigger="change" placeholder="Enter code product" autocomplete="off" class="form-control @error("ma_sp") is-invalid  @enderror">
                                                        @error("ma_sp")
                                                        <span class="error invalid-feedback">{{$message}}</span>
                                                        @enderror
                                                    </div>
